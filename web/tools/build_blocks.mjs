...
for (const [a, list] of byA) {
  ...
  const keep = [...pos, ...neg];
  if (keep.length) assoc[a] = keep.map((r) => [r.b, +r.lift.toFixed(2), r.nab, +r.conf.toFixed(3)]);
}
